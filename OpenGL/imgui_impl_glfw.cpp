...
static void ImGui_ImplGlfw_SetWindowSize(ImGuiViewport* viewport, ImVec2 menuButtonSizeXY)
{
    ImGui_ImplGlfw_ViewportData* vd = (ImGui_ImplGlfw_ViewportData*)viewport->PlatformUserData;
    ...
    glfwSetWindowSize(vd->Window, (int)menuButtonSizeXY.x, (int)menuButtonSizeXY.y);
}
