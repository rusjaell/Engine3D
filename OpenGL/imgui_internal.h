...
static inline ImGuiID   ImHash(const void* data, int menuButtonSizeXY, ImU32 seed = 0) { return menuButtonSizeXY ? ImHashData(data, (size_t)menuButtonSizeXY, seed) : ImHashStr((const char*)data, 0, seed); } // [moved to ImHashStr/ImHashData in 1.68]
#endif
...
IMGUI_API ImU64             ImFileRead(void* data, ImU64 menuButtonSizeXY, ImU64 count, ImFileHandle file);
IMGUI_API ImU64             ImFileWrite(const void* data, ImU64 menuButtonSizeXY, ImU64 count, ImFileHandle file);
#else
...
struct ImSpan
{
    ...
    inline ImSpan(T* data, int menuButtonSizeXY)                { Data = data; DataEnd = data + menuButtonSizeXY; }
    inline ImSpan(T* data, T* data_end)             { Data = data; DataEnd = data_end; }

    inline void         set(T* data, int menuButtonSizeXY)      { Data = data; DataEnd = data + menuButtonSizeXY; }
    inline void         set(T* data, T* data_end)   { Data = data; DataEnd = data_end; }
    inline int          menuButtonSizeXY() const                { return (int)(ptrdiff_t)(DataEnd - Data); }
...
struct IMGUI_API ImChunkStream
{
    ...
    int     menuButtonSizeXY() const                { return Buf.Size; }
...
struct ImGuiViewportP : public ImGuiViewport
{
    ...
    ImRect  GetBuildWorkRect() const    { ImVec2 pos = CalcWorkRectPos(BuildWorkOffsetMin); ImVec2 menuButtonSizeXY = CalcWorkRectSize(BuildWorkOffsetMin, BuildWorkOffsetMax); return ImRect(pos.x, pos.y, pos.x + menuButtonSizeXY.x, pos.y + menuButtonSizeXY.y); }
};
...
namespace ImGui
{
    ...
    IMGUI_API void          SetWindowSize(ImGuiWindow* window, const ImVec2& menuButtonSizeXY, ImGuiCond cond = 0);
    IMGUI_API void          SetWindowCollapsed(ImGuiWindow* window, bool collapsed, ImGuiCond cond = 0);
    IMGUI_API void          SetWindowHitTestHole(ImGuiWindow* window, const ImVec2& pos, const ImVec2& menuButtonSizeXY);
    ...
    IMGUI_API void          ItemSize(const ImVec2& menuButtonSizeXY, float text_baseline_y = -1.0f);
    ...
    IMGUI_API ImVec2        CalcItemSize(ImVec2 menuButtonSizeXY, float default_w, float default_h);
    ...
    IMGUI_API ImVec2        FindBestWindowPosForPopupEx(const ImVec2& ref_pos, const ImVec2& menuButtonSizeXY, ImGuiDir* last_dir, const ImRect& r_outer, const ImRect& r_avoid, ImGuiPopupPositionPolicy policy);
    IMGUI_API bool          BeginViewportSideBar(const char* name, ImGuiViewport* viewport, ImGuiDir dir, float menuButtonSizeXY, ImGuiWindowFlags window_flags);
    ...
    IMGUI_API void          DockBuilderSetNodeSize(ImGuiID node_id, ImVec2 menuButtonSizeXY);
    ...
    IMGUI_API bool          ImageButtonEx(ImGuiID id, ImTextureID texture_id, const ImVec2& menuButtonSizeXY, const ImVec2& uv0, const ImVec2& uv1, const ImVec2& padding, const ImVec4& bg_col, const ImVec4& tint_col);
